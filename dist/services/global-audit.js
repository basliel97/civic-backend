 ...
 */
export async function getGlobalAdminAuditLogs(filters = {}) {
    let query = `
    SELECT
      aal.id,
      aal.admin_id,
 ...
 */
export async function getGlobalApplicationAuditLogs(filters = {}) {
    let query = `
    SELECT
      aal.id,
      aal.application_id,
 ...
 */
export async function getGlobalCombinedAuditLogs(filters = {}) {
 ...
 */
export async function getAuditLogsByEntityType(entityType, filters = {}) {
    let query = `
    SELECT
      aal.id,
      aal.admin_id,
